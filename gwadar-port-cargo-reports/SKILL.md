...
- Realistic commodity mix at Gwadar, given its early-stage status: mostly **bulk and general cargo** (e.g., wheat, fertilizer, construction materials, project cargo related to CPEC infrastructure works) rather than significant containerized trade. Container (TEU) throughput at Gwadar has historically been minimal to negligible compared to Karachi Port's or Port Qasim's container terminals — do not assume Gwadar has a comparable container business just because it is a modern deep-water port.
