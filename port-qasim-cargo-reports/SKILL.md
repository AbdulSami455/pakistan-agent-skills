...
- Use this skill for Port Qasim-specific operational data. If the question is about Karachi Port or Gwadar Port, this skill does not cover those — note the distinction and look for a port-specific source if needed.
